					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<hr>
								<a style="display:inline-block; margin-left:1em;" class="btn btn-lg btn-primary buttonagregar" data-target="#myModal"><i class="fa fa-plus"></i> Agregar publicidad</a>
								<br>
								<hr>

								<div class="row">

									<h2  style="margin-left:1em;" >Publicidades actuales</h2>
									...
									<div class="col-sm-6">
										<div style="margin-left:1em;" class="panel panel-green">
